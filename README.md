...
683326 | BINTANED BASA, JESÚS | (https://github.com/jebiba95/lab2-big-ws/tree/test) | [![Build Status](https://travis-ci.org/jebiba95/lab2-big-ws.svg?branch=test)](https://travis-ci.org/jebiba95/lab2-big-ws) | I implemented a test that verifies that correct translate a text in Spanish to Afrikaans.
